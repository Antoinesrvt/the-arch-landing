...
const ui = {
  fr: {
    ...
    "approach.subtitle": "Une combinaison unique de consulting stratégique et d'exécution spécialisée pour maximiser votre succès Web3.",
    "approach1.title": "Stratégie & Vision",
    "approach1.desc": "3 experts fondateurs coordonnent votre vision technique, financière et communautaire avec une expertise de haut niveau.",
    "approach2.title": "Exécution Spécialisée",
    "approach2.desc": "Notre réseau de spécialistes vérifiés implémente chaque aspect technique : dev, design, légal, grants, business dev.",
    "approach3.title": "Média & Communauté",
    "approach3.desc": "Notre plateforme média amplifie votre projet avec du contenu éducatif, une communauté active et des insights Web3.",
    // Services
    "services.title": '<span class="font-playfair">Notre Offre</span> <i class="font-playfair">360°</i>',
    "services.subtitle": "Nous couvrons l'ensemble du cycle de vie de votre projet Web3.",
    "service1.title": "Tech & Sécurité",
    "service1.desc": "Architecture blockchain, développement et audit de smart contracts, optimisation des coûts gas.",
    "service2.title": "Finance & Tokenomics",
    "service2.desc": "Modèles économiques durables, levée de fonds, listing exchanges et conformité réglementaire.",
    "service3.title": "Marketing & Croissance",
    "service3.desc": "Croissance organique, construction de communauté et amplification média via notre plateforme.",
    "service4.title": "Stratégie & Coordination",
    "service4.desc": "Vision globale, orchestration d'experts et gestion de projet pour garantir la cohérence.",
    // Philosophy
    ...
    // Founders
    "founders.title": '<span class="font-playfair">3 Coordinateurs</span> <i class="font-playfair">Experts</i>',
    "founders.subtitle": "Nos fondateurs coordonnent votre vision stratégique tout en orchestrant notre réseau de spécialistes pour une exécution parfaite.",
    "antoine.role": "Tech & Architecture",
    "antoine.desc": "CTO de 3 entreprises blockchain, expert en sécurité et optimisation. Antoine coordonne l'aspect technique de votre projet et supervise notre réseau de développeurs.",
    "aaron.role": "Finance & Tokenomics",
    "aaron.desc": "Expert DeFi et participant actif dans TokenomicsDAO. Aaron conçoit votre modèle économique et coordonne nos spécialistes financiers pour maximiser votre succès.",
    "samir.role": "Marketing & Communauté",
    "samir.desc": "Bâtisseur de communautés (+30 000 membres), expert en contenu et stratégie média. Samir coordonne notre réseau marketing et amplifie votre projet via notre plateforme.",
    // Network
    "network.title": '<span class="font-playfair">Notre Réseau</span> de <i class="font-playfair">Spécialistes</i>',
    "network.subtitle": "Un écosystème de partenaires de premier plan pour couvrir tous les aspects de votre projet.",
    ...
    "network.partners.subtitle": "Un écosystème de partenaires de premier plan pour couvrir tous les aspects de votre projet.",
    // Media & Community
    "media.title": '<span class="font-playfair">Média &</span> <i class="font-playfair">Communauté</i>',
    "media.subtitle": "Notre plateforme média amplifie votre projet avec du contenu éducatif, une communauté active et des insights Web3.",
  ...
  en: {
    ...
    "approach.subtitle": "A unique combination of strategic consulting and specialized execution to maximize your Web3 success.",
    "approach1.title": "Strategy & Vision",
    "approach1.desc": "3 founding experts coordinate your technical, financial and community vision with high-level expertise.",
    "approach2.title": "Specialized Execution",
    "approach2.desc": "Our network of verified specialists implements every technical aspect: dev, design, legal, grants, business dev.",
    "approach3.title": "Media & Community",
    "approach3.desc": "Our media platform amplifies your project with educational content, active community and Web3 insights.",
    // Services
    ...
    "service1.desc": "Blockchain architecture, smart contract development and auditing, gas cost optimization.",
    "service2.title": "Finance & Tokenomics",
    "service2.desc": "Sustainable economic models, fundraising strategy, exchange listings and regulatory compliance.",
    "service3.title": "Marketing & Growth",
    "service3.desc": "Organic growth, community building and media amplification via our platform.",
    "service4.title": "Strategy & Coordination",
    "service4.desc": "Global vision, expert orchestration and project management to ensure coherence.",
    // Philosophy
    ...
    // Founders
    "founders.title": '<span class="font-playfair">3 Expert</span> <i class="font-playfair">Coordinators</i>',
    "founders.subtitle": "Our founders coordinate your strategic vision while orchestrating our network of specialists for perfect execution.",
    "antoine.role": "Tech & Architecture",
    "antoine.desc": "CTO of 3 blockchain companies, security and optimization expert. Antoine coordinates the technical aspect of your project and supervises our developer network.",
    "aaron.role": "Finance & Tokenomics",
    "aaron.desc": "DeFi expert and active participant in TokenomicsDAO. Aaron designs your economic model and coordinates our financial specialists to maximize your success.",
    "samir.role": "Marketing & Community",
    "samir.desc": "Community builder (+30,000 members), content and media strategy expert. Samir coordinates our marketing network and amplifies your project through our platform.",
    // Network
    "network.title": '<span class="font-playfair">Our Network</span> of <i class="font-playfair">Specialists</i>',
    "network.subtitle": "An ecosystem of leading partners to cover all aspects of your project.",
    ...
    // Media & Community
    "media.title": '<span class="font-playfair">Media &</span> <i class="font-playfair">Community</i>',
    "media.subtitle": "Our media platform amplifies your project with educational content, active community and Web3 insights.",
...
export { defaultLang as d, ui as u };
